...
import type { GameStatus } from "../game/reversi";
import { Player } from "../game/reversi";
...
export const GameOverlay: React.FC<GameOverlayProps> = ({ 
    ...
    if (gameStatus && gameStatus !== 'inProgress') {
        ...
        if (gameStatus === 'blackWins') {
            ...
            resultClass = playerColor === Player.black ? "text-green-400" : "text-red-400";
        } else if (gameStatus === 'whiteWins') {
            resultMessage = playerColor === Player.white ? "You Win!" : "You Lose!";
            resultClass = playerColor === Player.white ? "text-green-400" : "text-red-400";
